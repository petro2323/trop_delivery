...
<body>
    ...
    <div class="dashboard">
        ...
        <div class="dashboard-menu">
            <a href="">Omiljeni</a>
            <a href="<?= base_url('dashboard/best-selling') ?>"
                <?= current_url(true)->getPath() === '/index.php/dashboard/best-selling' ? 'class="active"' : '' ?>>Najbolje prodavani</a>
            <a href="<?= base_url('dashboard/near-me') ?>"
                <?= current_url(true)->getPath() === '/index.php/dashboard/near-me' ? 'class="active"' : '' ?>>Blizu
                mene</a>
            <a href="">Promocija</a>
            ...
            <?php if (isset($foodRestaurants)): ?>
                <?php foreach ($foodRestaurants as $foodRestaurant): ?>
                    <div class="dashboard-card">
                        <img class="card-image" src="<?= base_url('food/' . $foodRestaurant['food_image']) ?>"
                            alt="<?= $foodRestaurant['food_title'] ?>">
                        <div class="card-detail">
                            ...
                            <p class="card-time"><span class="fas fa-clock"> <?= $foodRestaurant['delivery_time'] ?> min</span>
                            </p>
                        </div>
                    </div>
                <?php endforeach; ?>
